...
* **스크린샷:**
    ...
    ![힌트 기능](<img width="1014" height="1112" alt="image" src="https://github.com/user-attachments/assets/d21eb38f-050c-49ad-9ce6-0fdbe8f8f178" />
)
...
* **스크린샷:**
    ...
    ![하이 스코어](<img width="532" height="642" alt="image" src="https://github.com/user-attachments/assets/aae03b69-f384-4339-84b4-512d1182b4f8" />
)

### 5. 타이머 시각적 알림 (Issue #5)
* **설명:** 게임 시간이 60초를 경과하면 타이머의 글자 색상이 **빨간색**으로 변경되어 사용자에게 긴박감을 줍니다. 또한 999초가 넘어가면 `999+`로 표시되도록 예외 처리를 했습니다.
* **스크린샷:**
    ![타이머 기능](스크린샷_파일명_여기에_넣기.png)
